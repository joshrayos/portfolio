  ...
  return (
    <>
      <header className="w-full border-b-4 p-3 text-center">
        <h1 className="text-3xl font-extrabold">TOOLS I USE</h1>
      </header>
      <main className="p-6 flex flex-col justify-center items-center h-full lg:max-w-7xl mx-auto flex-1">
        ...
        >
          <div className="text-center mb-2">
            <p>
              I maintain a versatile, full-stack toolkit, specializing in modern
              front-end architecture and robust API design. This allows me to
              handle every phase of application development, from
        ...
        <div className="content flex flex-col md:flex-row md:flex-wrap items-stretch gap-2 mt-3">
          ...
          >
            <div className="tool-card p-4 flex flex-col gap-3 flex-1 border-4 m-3">
              <div className="tool-card__header mb-2">
                <h3 className="font-pix text-lg">BACK-END</h3>
              </div>
              <div className="tool-card__body flex flex-col gap-3">
                <Tool text="Node">
                  <FaNodeJs />
          ...
          >
            <div className="tool-card p-4 flex flex-col gap-3 flex-1 border-4 m-3">
              <div className="tool-card__header mb-2">
                <h3 className="font-pix text-lg">OTHER TOOLS</h3>
              </div>
              <div className="tool-card__body flex flex-col gap-3">
                <Tool text="Git">
                  <FaGitAlt />
